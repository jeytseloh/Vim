...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    # parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'CT'],
    #                     type=str, help='Image Net dataset path')
    # parser.add_argument('--inat-category', default='name',
    #                     choices=['kingdom', 'phylum', 'class', 'order', 'supercategory', 'family', 'genus', 'name', None],
...
def main(args):
    ...
    # dataset
    dataset_train = build_dataset_3d(is_train=True, args=args)
    dataset_val = build_dataset_3d(is_train=False, args=args)
    ...
    if args.ThreeAugment:
        ...
        data_loader_train.dataset.transform = new_data_aug_generator_3d(args)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('ATM22 training', parents=[get_args_parser()])
